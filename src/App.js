            ...
            <div>
                <Navbar fixedTop={true}>
                    ...
                    <Nav>
                        ...
                        <NavItem eventKey={3} href="#applications">Applications & Examples</NavItem>
                    ...
                    <Col md={12}>
                        ...
                        <PanelGroup accordion id="accordion-example">
                            ...
                            <Panel eventKey="2">
                                ...
                                <h4>Digestion</h4>
                                <p>There are two routes to obtaining antibodies or antibody fragments used for immunoliposomes. The first method involves isolating a full-antibody of interest and then using various endopeptidase to break it into the desired fragment type.</p>

                                <Thumbnail src="images/1499003529230.jpg" alt="100%">
                                    <p className="text-center">The different fragment types of an Antibody.<br/>(Antibody fragmentation. ThermoFisher 2018).</p>
                                </Thumbnail>

                                <p>There are many specific & non-specific endopeptidase that are useful for this task (Goding 1983). Fab' fragments can be generated by pepsin digestion of existing imunoglobulin (Ig)G molecules. (Kontermann 2006)</p>

                                <Thumbnail src="images/1499003529888.jpg" alt="100%">
                                    <p className="text-center">Papain digestion can be utilized to break antibodies into fragments. <br/>(Antibody fragmentation. ThermoFisher 2018).</p>
                                </Thumbnail>
                                

                                <h4>Fermentation of Escherichia Coli</h4>
                                
                                <p>In addition to digesting existing antibodies to obtain fragments of interest. Recombinant gene editing can be used to create organisms that create the desired antibody fragments (Koning 2003).</p>
                            ...
                            <Panel eventKey="3">
                                ...
                                <Panel.Body collapsible>
                                <p>Recall from the "Polyethylene glycol (PEG)" structure section that there are two types of immunoliposomes. In Type 1, antibodies are conjugated directly to the bilayer and type II they are conjugated to distal end of PEG molecules (Petrilli 2018).</p>
        ...
        return (
            <div className="applications-and-examples">
                ...
                <PanelGroup accordion id="accordion-example">
                    <Panel eventKey="1">
                        <Panel.Heading>
                            <Panel.Title toggle>Traversing the blood brain barrier to deliver TMZ to GBM stem cells.</Panel.Title>
                        </Panel.Heading>
                        <Panel.Body collapsible>
                            <Row>
                                <Col md="6">
                                    ...
                                    for GBM is injection of Temozolomide (TMZ), however it's effectiveness is limited because it cannot access the cancer
                            ...
                            <Row>
                                ...
                                <Col md="6">
                                    ...
                                    <p>The Angiopep-2 antibody fragment bound to the LRP-1 receptor on the endothelial cells of the blood brain barrier (BBB). This caused
                                    the immunoliposome to be transcytosed to the baso-lateral side of the endothelial cell (Kim et al. 2018). </p>
                                    <p>After traversing the BBB, the second antibody fragment, Anti-CD133 bound to the cancer stem cells and was able to deliver its TMZ cargo (Kim et al. 2018).</p>
                                </Col>
                            </Row>
                        </Panel.Body>
                    </Panel>
            ...
            <div class="challenges">
                ...
                <Row>
                    <Col md={12}>
                        ...
                        <p>Immunogenicity is defined as the, ability of a substance to provoke an immune response in the body of a human and other animal (Rafe2017).
                        In contrast to small-molecule based therapies, utilizing anti-body fragments can cause a immuneresponse. Additional safety testing is needed to determine if the
                        liposome formulation of a drug is safe.</p>
                        <br/>
                    </Col>
                </Row>
            </div>
...
class References extends Component {
    render() {
        ...
        const references = {
            ...
            'thermofisher2018-1': '"Antibody fragmentation". Accessed 10/21/2018. https://www.thermofisher.com/us/en/home/life-science/antibodies/antibodies-learning-center/antibodies-resource-library/antibody-methods/antibody-fragmentation.html'
        }
        ...
        const books = {
            ...
            'goding1983': 'Goding, J. (1983). Monoclonal Antibodies: Principles and Practice. Academic Press Inc., London, U.K.',
        }
